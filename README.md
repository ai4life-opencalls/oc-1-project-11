...
1. Download the example denoised image here: [MAX_CTRL_Wound1_project_denoised-1.tif](resources/example_data/MAX_CTRL_Wound1_project_denoised-1.tif)
...
9. Select this model in the `custom models` section and run it by clicking `run model`.
